...
<tr>
<th>애플리케이션 이름</th>
<td><input style="width:95%" name="app_name"></td>
</tr>
<tr>
...
<td>http://<input style="width:80%" name="api_allow"></td>
</tr>
<tr>
<th>앱 설명</th>
<td><input style="width:95%" name="description"></td>
</tr>
</table>
<div class="alert alert-success" role="alert"><a href="javascript:registApp()">등록하기</a></div>
</form>
</div>
</center>
