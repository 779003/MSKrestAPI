...
<td><input style="width:95%" name="app_name" value="${targetApp.app_name}"></td>
</tr>
<tr>
<th>사용 여부</th>
<td>
...
<tr>
<th>사용URL <small>-비 로그인 오픈 API로 등록된 환경에서만 API호출이 가능하도록 합니다.</small><br> (빈칸으로 둘 시 모든 환경 접근 허용)</th>
<td>http://<input style="width:80%" name="api_allow"  value='${targetApp.api_allow}'></td>
</tr>
<tr>
<th>앱 설명</th>
<td><input style="width:95%" name="description"  value="${targetApp.description}"></td>
</tr>
</table>
<input type="hidden" name="api_key" value="${targetApp.api_key}">
</form>
</div>
<div class="alert alert-success" role="alert"><a href="javascript:modifyApp()">수정하기</a></div>
</center>
