...
public enum Code {
	...
	NO_VALUE_UPDATE("1005", "수정하려는 정보가 없습니다."),
	NO_VALUE_DELETE("1006", "삭제하려는 정보가 없습니다."),
	...
	INVALID_KEY("2001", "호출하려는 서비스에서 사용할 수 없는 키입니다. APP정보를 확인해주세요. 사용여부가 미사용이거나 다른 API를 위한 KEY인지 확인해주세요."),
	NO_REFERER("2002", "본 API를 호출하는 서비스에서 정보가 없습니다. 본 서비스에서 API호출을 사용하기 원하면 APP의 접근설정을 모두 허용 해야합니다."),
	...
	BAD_REQUEST_1004("3003", "요청정보가 잘못되었습니다."),
	BAD_REQUEST_1005("3004", "요청정보가 잘못되었습니다. URL정보와 body정보가 일치하지않습니다."),
