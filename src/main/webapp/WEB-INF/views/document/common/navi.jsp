	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="백엔드서비스 소개"><a class="nav-link" href="/docs"> 
				<span class="nav-link-text">백엔드서비스 소개</span>
			</a></li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="오류 코드 정리"><a class="nav-link" href="/docs/code"> 
		...
		<ul class="navbar-nav ml-auto">
			<c:choose>
				<c:when test="${ssMemberId eq '' or ssMemberId eq null}">
					<li class="nav-item"><a class="nav-link" href="/usr/login">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="myPageDropdown" style="left: -30%;">
							<a class="dropdown-item" href="/usr/modify"> 
								<span class="text-success"> <i class="fas fa-user-circle"></i>
									<strong>&nbsp;내 정보 수정</strong>
								</span>
							</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="/apps"> 
								<span class="text-success"> <i class="fab fa-whmcs"></i> 
